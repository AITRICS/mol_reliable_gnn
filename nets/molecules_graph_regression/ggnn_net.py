...
"""
from layers.ggnn_layer import GGNNLayer
from layers.mlp_readout_layer import MLPReadout

class GGNNet(nn.Module):
    def __init__(self, net_params):
        ...
        self.layers = nn.ModuleList([
            GGNNLayer(hidden_dim, hidden_dim, dropout, self.graph_norm, 
                          self.batch_norm, self.layer_norm) for _ in range(n_layers)]) 
        self.linear_ro = nn.Linear(hidden_dim, out_dim, bias=True) 
